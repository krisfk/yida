...
<head>
    ...
    .p-index-slider__item--1 .p-index-slider__item-button:hover {
        background-color: #406d24;
        color: #ffffff;
    }
    ...
    .p-index-slider__item--2 .p-index-slider__item-button:hover {
        background-color: #406d24;
        color: #ffffff;
    }
    ...
    .p-index-slider__item--3 .p-index-slider__item-button:hover {
        background-color: #406d24;
        color: #ffffff;
    }
    ...
    #cb_1 a.p-index-banner__button:hover,
    #cb_1 a.p-index-banner:hover .p-index-banner__button {
        background-color: #406d24;
        color: #ffffff !important;
    }
    ...
    #cb_2 .p-index-boxes__item--1 .p-index-boxes__item-desc {
        color: #ffffff;
        font-size: 14px;
    }
    ...
    #cb_2 .p-index-boxes__item--2 .p-index-boxes__item-desc {
        color: #ffffff;
        font-size: 14px;
    }
    ...
    #cb_3 .p-cb__item-archive-link__button {
        background-color: #538C2F;
        color: #ffffff !important;
    }

    #cb_3 .p-cb__item-archive-link__button:hover {
        background-color: #406d24;
        color: #ffffff !important;
    }
    ...
    #site_info_widget-3 .p-siteinfo__title {
        font-size: 30px;
    }
    ...
    <link rel="icon" href="https://design-halue.com/wp-content/uploads/2020/02/favicon-150x150.png" sizes="32x32" />
    <link rel="icon" href="https://design-halue.com/wp-content/uploads/2020/02/favicon-300x300.png" sizes="192x192" />
    <link rel="apple-touch-icon" href="https://design-halue.com/wp-content/uploads/2020/02/favicon-300x300.png" />
    <meta name="msapplication-TileImage"
        content="https://design-halue.com/wp-content/uploads/2020/02/favicon-300x300.png" />
...
get_template_directory_uri().'/images/home-thumb-1.jpg'; ?>" alt="">
    ...
    <link rel='stylesheet' id='magnific-popup-css'
        href='<?php echo get_template_directory_uri().'/yida-assets/'; ?>magnific-popup.min.css?ver=3.1.0'
    ...
    <script type='text/javascript'
        src='<?php echo get_template_directory_uri().'/yida-assets/'; ?>front-page.js?ver=1.6'
    ...
    <script type='text/javascript'
        src='<?php echo get_template_directory_uri().'/yida-assets/'; ?>header-fix.js?ver=1.6'
    ...
    <script type='text/javascript'
        src='<?php echo get_template_directory_uri().'/yida-assets/'; ?>swiper.min.js?ver=5.3.6' id='swiper-js'>
    </script>
    <script>
    jQuery(function($) {
